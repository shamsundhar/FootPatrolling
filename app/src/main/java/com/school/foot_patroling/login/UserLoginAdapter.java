...
public class UserLoginAdapter extends ArrayAdapter<UserLoginDto> {

    private List<UserLoginDto> dataSet;
    Context mContext;
    ...
    public void setItems(List<UserLoginDto> items) {
        this.dataSet = items;
    }

    public UserLoginAdapter(List<UserLoginDto> items, Context context) {
    ...
    @Nullable
    @Override
    public UserLoginDto getItem(int position) {
...
//    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        UserLoginDto dataModel = getItem(position);
        // Check if an existing view is being reused, otherwise inflate the view
        UserLoginAdapter.ViewHolder viewHolder; // view lookup cache stored in tag

        final View result;

        if (convertView == null) {

            viewHolder = new UserLoginAdapter.ViewHolder();
            ...
            viewHolder = (UserLoginAdapter.ViewHolder) convertView.getTag();
            result=convertView;
        }
        ...
        viewHolder.title.setText(dataModel.getUserLoginId());
