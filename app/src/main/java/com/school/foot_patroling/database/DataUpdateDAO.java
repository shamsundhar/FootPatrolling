...
public class DataUpdateDAO {
    ...
    public boolean updateFacilityData(FacilityDto_ facilityDto, SQLiteDatabase db) {
...
//    }
    ...
    public boolean updateProductData(ProductDto_ productDto, SQLiteDatabase db) {
...
//    }
    ...
    public boolean updateUserLoginData(UserLoginDto_ userLoginDto, SQLiteDatabase db) {
