...
public class SectionsListAdapter extends ArrayAdapter<FootPatrollingSectionsDto> {
    ...
    public SectionsListAdapter(List<FootPatrollingSectionsDto> items, Context context) {
...
//    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SectionsListAdapter.ViewHolder viewHolder; // view lookup cache stored in tag

        final View result;

        if (convertView == null) {

            viewHolder = new SectionsListAdapter.ViewHolder();
            ...
            viewHolder = (SectionsListAdapter.ViewHolder) convertView.getTag();
            result=convertView;
        }
